...
export async function activate(context: vscode.ExtensionContext) {
	...
	outputChannel = vscode.window.createOutputChannel("mm-code")
	...
	if (!context.globalState.get("firstInstallCompleted")) {
		...
		try {
			await vscode.commands.executeCommand("mm-code.SidebarProvider.focus")
			...
			await vscode.commands.executeCommand(
				...
				"mmcode.mm-code#kiloCodeWalkthrough",
				false,
			)
